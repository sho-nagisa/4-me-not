import type { InteractionType, ManagePanelId, PageId, PersonPanelId, ShareLevel } from "./types";
...
export const mobilePageOrder: PageId[] = ["record", "history", "home", "person", "manage"];
